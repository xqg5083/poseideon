...
<!--面包屑导航 开始-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/dataSource')}}"><i class="fa fa-plus"></i>数据源</a>
                <a href="{{url('admin/dataSync')}}"><i class="fa fa-recycle"></i>同步管理</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://newstrong.info</a></span>
                </li>
                <li>
