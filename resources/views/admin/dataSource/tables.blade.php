...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/indexall')}}">首页</a> &raquo; 数据表 &raquo;  <a herf="#" onclick="history.go(-1)" >返回</a>
</div>
<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <div class="result_content">
            <table class="list_tab">
                <tr>
                    <th class="tc" width="15%">数据表</th>
                    <th width="15%">备注</th>
                    <th width="15%">数据库引擎</th>
                    <th>操作</th>
                </tr>
                ...
                <tr>
                    ...
                    <td>{{$v->engine}}</td>
                    <td>
                        <a href="{{url('admin/dataTask/'.$v->db_id.'/'.$v->table_name.'/dataTaskBySource')}}">创建同步任务</a>
                        <a href="{{url('admin/dataSource/'.$v->db_id.'/'.$v->table_name.'/showColumn')}}">查看字段</a>
                    </td>
                </tr>
                @endforeach
            </table>
