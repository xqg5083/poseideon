...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/indexall')}}">首页</a> &raquo; 编辑数据源
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    <form action="{{url('admin/dataSource/'.$field->id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="show_name" value="{{$field->show_name}}" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="host"  value="{{$field->host}}">
            ...
            <tr>
                <th>端口：</th>
                <td>
                    <input type="text" class="sm" name="port" value="{{$field->port}}">
            ...
            <tr>
                <th>数据库：</th>
                <td>
                    <input type="text"  name="db" value="{{$field->db}}">
            ...
            <tr>
                <th>用户名：</th>
                <td>
                    <input type="text"  name="db_user" value="{{$field->db_user}}">
            ...
            <tr>
                <th>密码：</th>
                <td>
                    <input type="text"  name="db_pwd" value="{{$field->db_pwd}}">
