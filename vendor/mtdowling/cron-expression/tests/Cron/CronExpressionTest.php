...
class CronExpressionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        return array(
            array('*/2 */2 * * *', '2018-08-10 21:47:27', '2018-08-10 22:00:00', false),
            array('* * * * *', '2018-08-10 21:50:37', '2018-08-10 21:50:00', true),
            array('* 20,21,22 * * *', '2018-08-10 21:50:00', '2018-08-10 21:50:00', true),
            // Handles CSV values
            array('* 20,22 * * *', '2018-08-10 21:50:00', '2018-08-10 22:00:00', false),
            // CSV values can be complex
            array('* 5,21-22 * * *', '2018-08-10 21:50:00', '2018-08-10 21:50:00', true),
            array('7-9 * */9 * *', '2018-08-10 22:02:33', '2018-08-18 00:07:00', false),
            // 15th minute, of the second hour, every 15 days, in January, every Friday
            array('1 * * * 7', '2018-08-10 21:47:27', '2018-08-16 00:01:00', false),
            // Test with exact times
            array('47 21 * * *', strtotime('2018-08-10 21:47:30'), '2018-08-10 21:47:00', true),
    ...
    public function testProvidesMultipleRunDatesForTheFarFuture() {
        ...
        ), $cron->getMultipleRunDates(9, '2018-04-28 00:00:00', false, true));
    }
